...
/// Default appcast URL — GDrive so corporate users behind Squid can reach it
/// without needing GitHub access. Can be overridden in Settings → Advanced.
/// release.py keeps this file updated on GDrive after each release.
const appcastUrl = 'https://drive.usercontent.google.com/download?id=1jf-8thv_VVPIQ3k_n83UhygzEKkydI2p&export=download&confirm=t';

/// GitHub fallback (for igoogolx / open source users):
/// https://raw.githubusercontent.com/miguelAngelo1999/lux/personal/all-features/appcast.json
